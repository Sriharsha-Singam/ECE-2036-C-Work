...
// asteroid_sprite_4 initialization
int asteroid_sprite_4[ASTEROID_HEIGHT * ASTEROID_WIDTH] = {
        _,_,_,_,X,X,_,_,_,_,_,X,_,_,_,
        _,_,_,X,_,_,X,_,_,_,X,_,X,_,_,
        _,_,X,_,_,_,_,X,_,X,_,_,_,X,_,
        _,X,_,_,_,_,_,_,X,_,_,_,_,_,X,
        X,_,_,_,_,_,_,_,_,_,_,_,_,X,_,
        _,X,_,_,_,_,_,_,_,_,_,_,X,_,_,
        _,_,X,_,_,_,_,_,_,_,_,_,_,X,_,
        _,X,_,_,_,_,_,_,_,_,_,_,_,_,X,
        X,_,_,_,_,_,_,_,_,_,_,_,_,X,_,
        _,X,_,_,_,X,X,_,_,_,_,_,X,_,_,
        _,_,X,_,X,_,_,X,X,_,_,X,_,_,_,
